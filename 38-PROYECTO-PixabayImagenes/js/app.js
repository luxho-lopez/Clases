...
// Funcion  para la consulta de pyxabay
function buscarImagenes() {

    const termino = document.querySelector('#termino').value ;

    const key = '37985450-29d841b18aa91b2ec3dfc8aec';
...
function mostrarImagenes(imagenes) {
    // Limpia todo el HTML del resultado
...
function imprimirPaginador() {
    ...
    while(true) {
        ...
        // Si ya estamos en el final, ya no ejecuta nada
        if(done) return;

        // caso contrario, genera un boton para cada elemento
